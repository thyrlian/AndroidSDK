...
# launch emulator
emulator64-arm -avd test -no-audio -no-boot-anim -accel on -gpu swiftshader_indirect &
```
...
* Launch emulator in background
  ...
  emulator64-arm -avd <virtual_device_name> -no-audio -no-boot-anim -no-window -accel on -gpu off &
  
  # or
  emulator64-mips -avd <virtual_device_name> -no-audio -no-boot-anim -no-window -accel on -gpu off &
  
  # or
  emulator64-x86 -avd <virtual_device_name> -no-audio -no-boot-anim -no-window -accel on -gpu off &
